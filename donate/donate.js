//SWEET ALERT
         ...
         function closePopup() {
             ...
             }, 500); // Aguarde o término da animação antes de ocultar o popup
         }
         ...
         function copyText(elementId) {
             ...
             Swal.fire({
                 ...
                 html: elementId === 'pix' ? 'Use a opção <span class="highlight">CHAVE ALEATÓRIA</span> no app do seu banco.' : 'Use a opção <span class="highlight">COPIA e COLA</span> no app do seu banco.',
                 icon: 'success',
